            ...
            <div class="col-lg-6">
              ...
              <div class="card position-relative">
                ...
                <div class="card-body">
                  ...
                  <p class="mb-0 small">Note: This utility animates the CSS transform property, meaning it will override
                    any existing transforms on an element being animated! In this theme, the grow in animation is only being
                    used on dropdowns within the navbar.</p>
                </div>
              </div>
            ...
            <div class="col-lg-6">
              ...
              <div class="card position-relative">
                ...
                <div class="card-body">
                  ...
                  <p class="mb-0 small">Note: This utility animates the CSS opacity property, meaning it will override
