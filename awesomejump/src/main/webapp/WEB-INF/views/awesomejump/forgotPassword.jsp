...
<div class="container">
	<div class="mid">
		...
		<h3 style="font-family: 'NANUM';font-weight: bold; font-size: 30px;">비밀번호 찾기</h3>
		<input type="text" id="email" name="email" placeholder="이메일을 입력해주세요" style="text-align: center; font-size: 20px; font-family: 'NANUM';"><br>
		<div id="loading">
		...
		<input type="button" value="이메일로 비밀번호 찾기" onclick="emailCheck();" class="btn btn-primary" style="padding: 20px 80px; font-family: 'NANUM'; font-weight: bold; font-size: 25px;">
	</div>
