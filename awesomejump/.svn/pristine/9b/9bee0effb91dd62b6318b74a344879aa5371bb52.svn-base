      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-flex align-items-center">
            <h1 class="h3 mb-2 text-gray-800 ml-1 mt-4">회원 목록</h1>
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th><span>이메일</span></th>
                      <th><span>닉네임</span></th>
                      <th><span>최종 로그인</span></th>
                      <th><span>계정 상태</span></th>
                    </tr>
                  </thead>
                  <tbody>
                    <c:forEach var="member" items="${memberList}">
                      <tr>
                        ...
                        <td>${member.mem_enabled_yn eq 1 ? '활성화' : '비활성화'}</td>
                      </tr>
                    </c:forEach>
                  </tbody>
                </table>
              ...
              <c:if test="${pageParam.lastBlockNum == -1}">
                <div class="text-center">
                  <div class="lead">검색 결과가 존재하지 않습니다.</div>
                </div>
              </c:if>
            </div>
          </div>
      ...
      <div class="modal-content">
        <form action="/admin/members" method="GET" id="searchForm">
          <div class="modal-header">
            <h5 class="modal-title" id="searchModalLabel">회원 검색</h5>
          ...
          <div class="modal-body">
            <div class="form-group row">
              <label for="search_email" class="offset-lg-2 col-lg-2 col-form-label">이메일</label>
              <div class="col-lg-6">
                <input type="text" class="form-control" id="search_email" name="email">
              </div>
            </div>
            <div class="form-group row">
              <label for="search_nickname" class="offset-lg-2 col-lg-2 col-form-label">닉네임</label>
              <div class="col-lg-6">
                <input type="text" class="form-control" id="search_nickname" name="nickname">
              </div>
            </div>
            <div class="form-group row">
              <label for="search_lastLoginBegin" class="offset-lg-2 col-lg-2 col-form-label">최종 로그인</label>
            </div>
            <div class="row">
              <div class="col-lg-4 col-sm-6 offset-lg-2 mb-3">
                <input class="form-control" type="date" id="search_lastLoginBegin" placeholder="시작일" name="lastLoginBegin">
              </div>
              <div class="col-lg-4 col-sm-6">
                <input class="form-control" type="date" id="search_lastLoginEnd" placeholder="종료일" name="lastLoginEnd">
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-lg-4 col-sm-6 mt-3">
                <label>활성화 <input type="radio" name="status" value="1" style="font-size: 1.1rem;"></label>
                <label>비활성화 <input type="radio" name="status" value="0" style="font-size: 1.1rem;"></label>
              </div>
            </div>
          </div>
