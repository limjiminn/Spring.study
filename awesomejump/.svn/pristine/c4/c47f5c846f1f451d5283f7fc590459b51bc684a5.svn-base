             ...
             <div class="col-md-4 form-group  col-form-label">
          	...
          	<div class="col-md-8 form-group">
	            ...
	            <div class="col-md-4 form-group  col-form-label">
	              ...
	              <div class="col-md-6 form-group">
	                <select class="nice-select option_select1" id="selbox1" name="selbox1">
           ...
           <c:forEach items="${checkout}" var="checkout">
	            <div class="border" data-checkout="${checkout.product_name}">
	                  <div class="media">
	                    ...
	                    <div>
	                      ...
	                      <input type="hidden" id="productImage" name="productImage" value="${checkout.product_image_path}">
           	...
           	<form class="row contact_form" action="#" method="post" novalidate="novalidate">	
	            ...
	            <div class="col-md-4 " >
	            	...
	            	<input type="hidden" class="form-control" id="cp_no" value="0" readonly/>  	
	            </div>
	           <div class="col-md-8 form-group">
			    ...
			    if (rsp.success) {
			       ...
			       // alert("결제 성공");
			        /*사용한 쿠폰  */
					 ...
					 var updateCp={coupon_no:$("#cp_no").val()};
			        ...
			        var orderInfo = {
			    			...
			    			order_info_request: ($("#selboxDirect").val() == ''? $("#selbox1 option:selected").val(): $("#selboxDirect").val())
			    		};
...
function ch2(cp,price,num) {
   ...
   // alert($("#newcoupon"+num).val());
   $('#cp_no').val($("#newcoupon"+num).val());
