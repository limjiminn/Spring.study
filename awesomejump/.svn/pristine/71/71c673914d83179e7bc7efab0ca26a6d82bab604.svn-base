	...
	<div class="mid">	
		...
		<nav>
		  <div class="nav nav-tabs" id="nav-tab" role="tablist">
		    <a class="nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true" style="text-align: center;">사용가능</a>
		    <a class="nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false" style="text-align: center;">사용완료</a>
		  </div>
		</nav>
		...
		<div class="tab-content" id="nav-tabContent">
		  <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
			  ...
			  <thead>
			    <tr>
			      ...
			      <th scope="col" style="width: 20%;">할인금액</th>
			      <th scope="col" style="width: 20%;">발급날짜</th>
			      <th scope="col" style="width: 25%;">유효기간</th>
			    </tr>
			  </thead>
			  <tbody>
			  <c:forEach items="${p_couponList}" var="p_couponList" varStatus="status">
			      ...
			      <td>${p_couponList.coupon_discount}원</td>
		  ...
		  <table class="table table-hover">
			  ...
			  <c:forEach items="${imp_couponList}" var="imp_couponList" varStatus="status">
			    ...
			    <h4 style="text-align: center;">---&nbsp;&nbsp;사용완료된 쿠폰내역은 30일 이후 삭제됩니다&nbsp;&nbsp;---</h4>
		  </div>
		</div>
	</div>
</div>
