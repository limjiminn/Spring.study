  ...
  <div id="wrapper">
   ...
   <%--  <jsp:include page="/WEB-INF/templates/admin/sidebar.jsp"/> --%>
    ...
    <div id="content-wrapper" class="d-flex flex-column" style="background-color: white;">
		  <h1 align="center" style="margin: 100px 100px 100px 100px; color: gray;">환영합니다. 관리자님</h1>
		  <div align="center">
			  <div class="first"  style="float: left; width: 33%; color: blue;">
			   	...
			   	<div style="margin-top: 20px; color: black; font-size: 30px;"><a class="nav-link" href="/admin/members">회원관리</a></div>
			  </div>
			  <div style="float: left; width: 33%; color: blue;">
		    	...
		    	<div style="margin-top: 20px; color: black; font-size: 30px;"><a class="nav-link" href="/admin/listProduct">상품목록</a></div>
			  </div>
			  <div style="float: left; width: 33%; color: blue; margin-bottom: 100px;">
		    	...
		    	<div style="margin-top: 20px; color: black; font-size: 30px;"><a class="nav-link" href="/admin/insertProduct">상품등록</a></div>
			  </div>
