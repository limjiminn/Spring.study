...
<head>
  ...
  <title>AwesomeJump - Blog Details</title>
									...
									<div class="single-post row">
											<div class="col-lg-12">
													<div class="feature-img">
															<img class="img-fluid" src="/resources/awesomejump/img/blog/feature-img1.jpg" alt="">
													</div>
											</div>
											...
											<div class="col-lg-12">
													...
													<div class="row">
															<div class="col-6">
																	<img class="img-fluid" src="/resources/awesomejump/img/blog/post-img1.jpg" alt="">
															</div>
															<div class="col-6">
																	<img class="img-fluid" src="/resources/awesomejump/img/blog/post-img2.jpg" alt="">
															</div>
									...
									<div class="navigation-area">
											<div class="row">
													<div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
															<div class="thumb">
																	<a href="#">
																			<img class="img-fluid" src="/resources/awesomejump/img/blog/prev.jpg" alt="">
																	</a>
															</div>
															<div class="arrow">
																	<a href="#">
													...
													<div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
															...
															<div class="thumb">
																	<a href="#">
																			<img class="img-fluid" src="/resources/awesomejump/img/blog/next.jpg" alt="">
																	</a>
															</div>
													</div>
											</div>
									...
									<div class="comments-area">
											...
											<div class="comment-list">
													<div class="single-comment justify-content-between d-flex">
															<div class="user justify-content-between d-flex">
																	<div class="thumb">
																			<img src="/resources/awesomejump/img/blog/c1.jpg" alt="">
																	</div>
																	<div class="desc">
																			<h5>
											...
											<div class="comment-list left-padding">
													<div class="single-comment justify-content-between d-flex">
															<div class="user justify-content-between d-flex">
																	<div class="thumb">
																			<img src="/resources/awesomejump/img/blog/c2.jpg" alt="">
																	</div>
																	<div class="desc">
																			<h5>
											...
											<div class="comment-list left-padding">
													<div class="single-comment justify-content-between d-flex">
															<div class="user justify-content-between d-flex">
																	<div class="thumb">
																			<img src="/resources/awesomejump/img/blog/c3.jpg" alt="">
																	</div>
																	<div class="desc">
																			<h5>
											...
											<div class="comment-list">
													<div class="single-comment justify-content-between d-flex">
															<div class="user justify-content-between d-flex">
																	<div class="thumb">
																			<img src="/resources/awesomejump/img/blog/c4.jpg" alt="">
																	</div>
																	<div class="desc">
																			<h5>
																					<a href="#">Maria Luna</a>
											...
											<div class="comment-list">
													<div class="single-comment justify-content-between d-flex">
															<div class="user justify-content-between d-flex">
																	<div class="thumb">
																			<img src="/resources/awesomejump/img/blog/c5.jpg" alt="">
																	</div>
																	<div class="desc">
																			<h5>
																					<a href="#">Ina Hayes</a>
