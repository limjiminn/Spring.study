...
public interface MemProductMapper {
	...
	public String avgReviewGrade(int product_no) throws Exception;
	...
	// 주영/ 여러 상품 이미지 출력
	public List<ReviewImageDTO> selectProductAllReviewImageList(List<Integer> review_no_list) throws Exception;
	
	public int countIfOptionExistsOnProduct(Map<String, Object> map) throws Exception;
