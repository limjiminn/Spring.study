                      ...
                      <tbody>
                          <tr>
                              <td>
                                  <div class="media">
                                      <div class="d-flex">
                                          <img src="/resources/awesomejump/img/cart/cart1.png" alt="">
                                      </div>
                          ...
                          <tr>
                              <td>
                                  <div class="media">
                                      <div class="d-flex">
                                          <img src="/resources/awesomejump/img/cart/cart2.png" alt="">
                                      </div>
                                      <div class="media-body">
                                          <p>Minimalistic shop for multipurpose use</p>
                                      </div>
                          ...
                          <tr>
                              <td>
                                  <div class="media">
                                      <div class="d-flex">
                                          <img src="/resources/awesomejump/img/cart/cart3.png" alt="">
                                      </div>
                                      <div class="media-body">
                                          <p>Minimalistic shop for multipurpose use</p>
                                      </div>
