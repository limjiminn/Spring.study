          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user">
                ...
                <a href="/admin/login" class="btn btn-primary btn-user btn-block"> Register Account </a>
                <hr>
                <a href="/admin" class="btn btn-google btn-user btn-block"> <i class="fab fa-google fa-fw"></i>
                  Register with Google
                </a> <a href="/admin" class="btn btn-facebook btn-user btn-block"> <i class="fab fa-facebook-f fa-fw"></i>
